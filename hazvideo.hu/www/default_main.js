...
// &ar_tol=3&ar_ig=30&szintek_tol=4&szintek_ig=40&garazs=1
  ...
  keres['kategoria'] = document.getElementById('reg_kategoria').value;
  keres['jelleg'] = document.getElementById('reg_jelleg').value;
  
  keres['szobak_tol'] = document.getElementById('reg_szobak_tol').value.split(',').join('.');
  keres['szobak_ig'] = document.getElementById('reg_szobak_ig').value.split(',').join('.');
  
  keres['alapterulet_tol'] = document.getElementById('reg_alapterulet_tol').value;
  keres['alapterulet_ig'] = document.getElementById('reg_alapterulet_ig').value;
  
  keres['ar_tol'] = document.getElementById('reg_ar_tol').value;
  keres['ar_ig'] = document.getElementById('reg_ar_ig').value;
  
  keres['szintek_tol'] = document.getElementById('reg_szintek_tol').value.split(',').join('.');
  keres['szintek_ig'] = document.getElementById('reg_szintek_ig').value.split(',').join('.');
  
  keres['garazs'] = document.getElementById('reg_garazs').value;
