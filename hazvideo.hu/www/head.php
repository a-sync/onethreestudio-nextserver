...
<head>
  ...
  <meta name="keywords" content="<?php echo implode(', ', $data['kategoria']).', '.implode(', ', $data['jelleg']).' hirdetés, videók, képek, jutalék nélkül'; ?>" />

  <title>Hirdesse ingatlanát biztonságosan és jutalékmentesen.</title>
  ...
  <div id="container">
    ...
    <div id="head">
      ...
      <div id="right_head">
        ...
        <div id="top_menu"><div><div>
          <a class="top_menu_item" href="index.php">Főoldal</a>
          <a class="top_menu_item" href="rolunk.php">Rólunk</a>
          <a class="top_menu_item" href="utmutato.php">Útmutató</a>
          <a class="top_menu_item" href="arak.php">Árak</a>
          <a class="top_menu_item" href="kapcsolat.php">Kapcsolat</a>
          <a class="top_menu_item top_menu_item_high" href="belepes.php">Belépés</a>
        </div></div></div>
      </div>
    ...
    <div id="body">
      ...
      ?>
        ...
        <h2><a href="ugyvedi-segitseg.php">Ügyvédi segítség</a></h2>
