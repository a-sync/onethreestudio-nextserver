...
?>
          ...
          <div id="video_box_right">
            ...
            ?>
              ...
              <br/><br/>
              <span class="video_box_data_gray">Ár: <?php echo number_format($hirdetes['ar'], 0, '', ' '); ?> Ft</span>
              <br/><br/>
              Kategória: <?php echo $data['kategoria'][$hirdetes['kategoria']]; ?>
              <br/><br/>
              <span class="video_box_data_gray">Jelleg: <?php echo $data['jelleg'][$hirdetes['jelleg']]; ?></span>
              <br/><br/>
              Szobák száma: <?php echo $hirdetes['szobak']; ?>
              <br/><br/>
              <span class="video_box_data_gray">Szintek: <?php echo $hirdetes['szintek']; ?></span>
              <br/><br/>
...
//echo '00';//debug
  ...
  elseif(is_numeric($_POST['hiid'])) {
    ...
    if($hirdetes == false) {
      ...
      $uzenet = 'Üdvözlöm.'."\r\n"
               .'Egyik ismerőse úgy döntött, hogy megosztja önnel a www.hazvideo.hu egyik hirdetését.'."\r\n"
               .'A hirdetést máris megtekintheti, csak kattintson a levélben található linkre, vagy másolja azt be a böngészőjébe.'."\r\n"
               .''."\r\n"
               .'Hirdetés adatlapja: http://hazvideo.hu/hirdetesek.php?hirdetes='.$hiid."\r\n"
               .'Hirdetés nyomtatása: http://hazvideo.hu/hirdetes-nyomtatasa.php?hirdetes='.$hiid."\r\n";
