...
$register_globals_text=<<<out
<span style="color:green"><b>Perfect!</b> This setting is configured accordingly to PHP and miniBB team recommendations.</span>
out;
}
...
$php_text=<<<out
<span style="color:green"><b>Perfect!</b>. You have an up-to-date PHP version which is recommended by miniBB team.</span>
out;
}
...
<p>We're offerring few paid support plans regarding this software (basic board installation on your server costs only US $15 - it's one-time payment). To get paid support, use <a href="http://www.minibb.com/forums/index.php?action=tpl&amp;tplName=contact_us_form">this form</a> to contact us. Describe the problem you're having, and we'll setup the board for you shortly. We're also offering other services in <a href="http://www.minibb.com/paid_support.html">paid support</a>. Feel free to contact us anytime!</p>
