...
Latest File Update: 2009-Jan-26
*/
...
if(isset($mod_rewrite) and $mod_rewrite and $sortBy==0) $urlp="{$forum}_{$topic}_{$realPage}.html";
else $urlp="{$indexphp}action=vthread&forum=$forum&topic={$topic}&page={$realPage}";
...
$pageNav=pageNav($page,$numRows,$urlp,$viewmaxreplys,FALSE,(isset($mod_rewrite) and $mod_rewrite));
if($pageNav!='') $mbpn='mb';
