...
Latest File Update: 2007-Oct-02
*/
...
if(!defined('ADMIN_USER_TMP') and $genEmailDisable!=1 and isset($closeRegister) and $closeRegister==1 and strtolower($userData[$dbUserSheme['user_email'][0]])!=strtolower(${$dbUserSheme['user_email'][2]})){
