...
Latest File Update: 2009-Jan-27
*/
...
if(isset($_GET['page'])) $page=(int)$_GET['page']+0; elseif(isset($_POST['page'])) $page=(int)$_POST['page']+0; else $page=0;
...
$pageNav=pageNav($page,$num,"{$main_url}/{$bb_admin}action=searchusers2&amp;whatus=&amp;page=",$viewmaxsearch,FALSE);
...
$makeLim=makeLim($page,$num,$viewmaxsearch);
$pageNav=pageNav($page,$num,"{$main_url}/{$bb_admin}action=searchusers2&amp;whatus={$whatus}&amp;searchus=inactive&amp;page=",$viewmaxsearch,FALSE);
...
$makeLim=makeLim($page,$num,$viewmaxsearch);
$pageNav=pageNav($page,$num,"{$main_url}/{$bb_admin}action=searchusers2&amp;whatus={$whatus}&amp;searchus=$searchus&amp;page=",$viewmaxsearch,FALSE);
...
$num=$countRes;
$makeLim=makeLim($page,$num,$viewmaxsearch);
$pageNav=pageNav($page,$num,"{$main_url}/{$bb_admin}action=searchusers2&amp;whatus={$whatus}&amp;searchus=registr&amp;page=",$viewmaxsearch,FALSE);
...
$makeLim=makeLim($page,$num,$viewmaxsearch);
$pageNav=pageNav($page,$num,"{$main_url}/{$bb_admin}action=searchusers2&amp;whatus={$whatus}&amp;searchus=notmember&amp;page=",$viewmaxsearch,FALSE);
