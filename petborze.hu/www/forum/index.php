...
if(isset($_GET['page'])) $page=(integer)$_GET['page']+0; elseif(isset($_POST['page'])) $page=(integer)$_POST['page']+0; else $page=0;
...
elseif((integer)($totalPosts/$GLOBALS['viewmaxreplys'])==($totalPosts/$GLOBALS['viewmaxreplys'])) $page=$totalPosts/$GLOBALS['viewmaxreplys']-1;
...
<!--Copyright link. You have no right to remove it if you use the free GPL licence. Refer to COPYING file for more-->
{$l_poweredBy} <a href="http://www.minibb.com" target="_blank">miniBB</a>&reg;
