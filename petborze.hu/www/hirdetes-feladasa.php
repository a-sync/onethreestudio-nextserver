...
if($_POST['kuldes'] != '' && $hibak == false || (count($hibak) == 1 && $hibak['hiid'] != '')) {
  ...
  $targy = 'www.petborze.hu - Sikeres regisztráció!';
  $uzenet = 'Üdvözlöm.'."\r\n"
           .'Ön sikeresen regisztrálta hirdetését a www.petborze.hu oldalon.'."\r\n"
           ...
           .'Addigis bármikor kapcsolatba léphet velünk a http://petborze.hu/kapcsolat.php oldalon megadott elérhetőségek valamelyikén ha kérdése vagy problémája lenne.'."\r\n"
           .'Ha módosítani szeretné a hirdetéseit, kérem lépjen be az oldalra a http://petborze.hu/belepes.php címen.'."\r\n"
      ...
      <div id="content_frame">
        ...
        <div id="content">
            ...
            ?>
              ...
              <strong><a target="_blank" href="hirdetes-modositasa.php?hirdetes=<?php echo $q; ?>">http://petborze.hu/belepes.php?hirdetes=<?php echo $q; ?></a></strong>
              <br/><br/>
