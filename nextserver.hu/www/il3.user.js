...
function idezett_link(e, n)
{
  ...
  if(n === false)
  {
    ...
    {
      qlink = '[url=http://' + domain + '/forums.php?action=viewpost&postid=' + _qid + ']#' + _qid + '[/url]';
      qlink2 = '[url=http://' + domain + '/forums.php?action=viewpost&postid=' + _qid + ']...[/url]';
    }
